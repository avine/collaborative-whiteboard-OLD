...
import {
  WhiteboardPublic,
  WhiteboardPublicListItem
} from '../../../../back/src/router/whiteboard/whiteboard.types';
...
export const getWhiteboardList = () =>
  axiosInstance.get<WhiteboardPublicListItem[]>('whiteboard/list', {
